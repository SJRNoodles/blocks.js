...
function inner_set(varia,div){
  ...
  document.getElementById("bjsfunction").innerHTML = " <button onclick='addcode(" + '"function ' + evalname + '(){","block"' + ");'>add function</button>" + "<button onclick='addcode(" + '"' + evalname + "();" + '"' + ",'block');'>now work</button>";
